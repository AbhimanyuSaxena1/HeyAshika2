  ...
  return (
    <div className='p-4 w-full relative h-screen bg-zinc-200 flex justify-center items-center'>
      ...
      <div className={`rounded-xl w-100 h-100  ${val == false ? "border-[#f991cc]": "border-[#ffdafc] "} border-6 border-dashed  relative overflow-hidden flex `}>
        <img src="/src/assets/img1.jpg" className={`  object-cover transition-transform duation-1000  ${val == false?"-translate-x[0%]" : "-translate-x-[100%]" } `}  alt="" />
        <img src="/src/assets/img2.jpg" className={`  object-cover transition-transform duation-1000  ${val == false?"-translate-x[0%]" : "-translate-x-[100%]" }`} alt="" />
        <img src="/src/assets/img1.jpg" className={`  object-cover transition-transform duation-1000  ${val == false?"-translate-x[0%]" : "-translate-x-[100%]" }`}  alt="" />
        <img src="/src/assets/img2.jpg" className={`  object-cover transition-transform duation-1000  ${val == false?"-translate-x[0%]" : "-translate-x-[100%]" }`} alt="" />
